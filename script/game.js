        ...
        score
            ...
            .then(function(score) {
                ...
                function tweet() {
                    ...
                    var tweethrefurl =
                        " href=http://twitter.com/share?url=https://google.com"; //https://aoyamafont.yu-nagi.com/
                    var rel = ` rel="noopener noreferrer"`;
                    var tweetContents = `<a class="tweetbotton"${tweethrefurl}${tweetPnMs}%0aフォント神経衰弱WEB%0a&hashtags=フォント神経衰弱WEB${rel}>スコアをTwetterで共有</a>`;
